...
void opengraph PROTO((void));;
void opengraphsize PROTO((int width,int height));
int keypressed PROTO((void));	

int buttonhit PROTO((void));
void getmouse PROTO((int&x,int& y));
int buttonpressed PROTO((void));
